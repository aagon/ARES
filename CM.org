...
Vu qu'on ne peut pas toujours être connecté au serveur de mail, soit par NFS (comme on faisait dans le temps jadis).
...
Problème de POP : ne supprime pas les messages du serveur, ne synchronise pas entre les éventuels clients.

**** IMAP

Internet Mail Access Protocol : permet la synchronisation, mais alors beaucoup plus coûteux.
